...
/*BOARD_HAVE_BLUETOOTH_RTK_COEX begin*/
                    ...
                    {
                        p_dev_rec->profile_map = 0x07;
                        rtk_add_le_profile(p_data->conn.bda,  p_dev_rec->hci_handle, p_dev_rec->profile_map);
                    }
#endif
/*BOARD_HAVE_BLUETOOTH_RTK_COEX end*/
        ...
        case BTA_HH_GET_DSCP_EVT:
            ...
            }
            {
				...
				cached_name = "KonKaTouch-0417-0062-bt";
...
static bt_status_t init( bthh_callbacks_t* callbacks )
{
   ...
   ALOGE("in btif_hh.c remote_controller_id = %d", (int)remote_controller_id);
   remote_controller_id = 2;
/*BOARD_HAVE_BLUETOOTH_RTK_VR begin*/
#ifdef BLUETOOTH_RTK_VR
    HH_task_running = TRUE;
    if(rtkbt_getRealRcuID(remote_controller_id) == RTKBT_RCUID_IFLYTEK) {
       RTKBT_Iflytek_init();
       ALOGE("after iflytek_init");
    } else
