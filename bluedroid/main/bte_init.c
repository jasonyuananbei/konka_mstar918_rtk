...
#ifdef BLUETOOTH_RTK
UINT32  remote_controller_id = 0;
#endif
#ifdef BLUETOOTH_RTK_VR
#include "rtk_msbc.h"
#include "bdroid_buildcfg.h"
UINT8  rtk_voice_input_data = 0xFF;
UINT8  rtk_voice_output_rpt_id = 0xFF;
#endif
...
{
#ifdef BLUETOOTH_RTK
if(remote_controller_id == 0)
    remote_controller_id = REMOTE_CONTROLLER_ID;
#endif

#ifdef BLUETOOTH_RTK_VR
RTKBT_VR_get_report_id(&rtk_voice_input_data, &rtk_voice_output_rpt_id, remote_controller_id);
#endif
...
#ifdef BLUETOOTH_RTK_VR
UINT32 RTKBT_VR_get_remote_controller_id(void)
{
