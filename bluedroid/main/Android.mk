...
local_STATIC_LIBRARIES += libbt-rtk_vr
endif
ifeq ($(BOARD_HAVE_BLUETOOTH_RTK_SCO),true)
local_STATIC_LIBRARIES += libbt-rtk_ui
endif
...
LOCAL_REQUIRED_MODULES := libbt-hci_rtk libbt-vendor_rtk bt_stack.conf bt_did.conf auto_pair_devlist.conf
