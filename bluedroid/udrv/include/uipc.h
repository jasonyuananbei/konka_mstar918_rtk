...
#ifdef BLUETOOTH_RTK
#define UIPC_CH_ID_RTKBT_VR_CTRL 2
#define UIPC_CH_ID_RTKBT_VR_AUDIO 3
...
/*******************************************************************************
**
** Function         UIPC_RTKBT_VR_Send_noblock
**
** Description      Called to transmit a message over UIPC.
**
** Returns          void
...
UDRV_API BOOLEAN UIPC_RTKBT_VR_Send_noblock(tUIPC_CH_ID ch_id, UINT16 msg_evt, UINT8 *p_buf, UINT16 msglen);
#endif
