...
/*******************************************************************************
**
** Function         BTM_rtkbt3ddSendCommand
**
** Description      Send a 3dd HCI command to the controller.
**
** Returns
**      BTM_SUCCESS         Command sent. Does not expect command complete
**                              event. (command cmpl callback param is NULL)
...
**
*******************************************************************************/
tBTM_STATUS BTM_rtkbt3ddSendCommand(UINT16 opcode, UINT8 param_len,
                                      UINT8 *p_param_buf)
{

    BTM_TRACE_EVENT2 ("BTM: BTM_rtkbt3ddSendCommand: Opcode: 0x%04X, ParamLen: %i.",
                      opcode, param_len);

    btsnd_hcic_rtkbt_3dd_cmd(opcode, param_len, p_param_buf);
