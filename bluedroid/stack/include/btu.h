...
#ifdef BLUETOOTH_RTK
TIMER_LIST_ENT   reconnect_timer_ent;
#define BTU_TTYPE_BLE_RECONNECT        108
#define BTU_TTYPE_BLE_RECONNECT_TIMEOUT        0

/*for RFCOMM credit timer*/
TIMER_LIST_ENT   rfc_credit_ent;
#define BTU_TTYPE_RFCOMM_CREDIT     109
#define BTU_TTYPE_RFCOMM_CREDIT_TIMEOUT       5
